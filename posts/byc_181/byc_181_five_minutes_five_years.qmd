...
bball_header <- glue::glue(
  "<div style='display: flex; justify-content: space-between; align-items: center;'>
     ...
     <div style='flex-grow:1; margin-left: 30px; margin-right: 30px'>
       <span style='display: block; font-weight: bold; text-align: center; font-size: 24px;'>The Final Four Since 1985</span>
       <span style='font-size: 14px; font-weight: normal; display: block; text-align: center;'><br>
       Highlights every Final Four appearance since the 1985 NCAA Tournament for the four teams in the 2026 Final Four.</span>
     </div>
     <div>
...
ff_tbl <- ncaa_ff_split |> 
  ...
  gt::tab_source_note(gt::html(
    "<hr>
       ...
       <br>
       <b>Most Final Four appearances in this span</b>: <br>
       Duke (14)<br>
       North Carolina (12)<br>
       Kansas (10)<br>
       UConn (8), Kentucky (8), Michigan State (8)<br>
       <br>
       <b>Most National Titles in this span</b>: <br>
       UConn (6)<br>
       Duke (5)<br>
       North Carolina (4)<br>
       Florida (3), Kansas (3), Kentucky (3), Villanova (3)<br>
       <hr>
     data via wikipedia.com and ncaa.com<br>
     First team listed is the NCAA Champion, not including 2026<br>
     <hr>
     <hr>
     April 2, 2026 | Table by Chris at Bless your Chart"
  )) |> 
